...
export const ChannelItem: React.FC<{ channel: IChannel }> = ({ channel }) => (
  <StyledSafeAreaView className="flex-1 justify-center items-center text-center bg-gray-900 w-[73%]">
    <StyledView className="mb-3 ml-[32%] p-4 rounded-lg bg-gray-700 shadow scroll-m-5 border-blue-500 border-b-2  border-r-2 w-full">
